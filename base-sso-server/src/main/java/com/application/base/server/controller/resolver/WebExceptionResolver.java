package com.application.base.server.controller.resolver;

import com.application.base.core.entity.ResultDataVO;
import com.application.base.core.exception.SsoException;
...
public class WebExceptionResolver implements HandlerExceptionResolver {
    ...
    public ModelAndView resolveException(HttpServletRequest request,
        ...
        // error result
        ResultDataVO<String> errorResult = null;
        if (ex instanceof SsoException) {
            errorResult = new ResultDataVO<String>("500", ex.getMessage());
        } else {
            errorResult = new ResultDataVO<String>("500", ex.toString().replaceAll("\n", "<br/>"));
        }
